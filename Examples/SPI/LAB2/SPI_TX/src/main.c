...
//uint32_t SPI1_Buffer_Data[BufferSize/2] = { 255,256,257,258,259,260,261,262,263,264,265,266,267,268,269,270};// SPI2_Buffer_Rx[BufferSize];
uint32_t SPI1_Buffer_Data[BufferSize/2] = {65536,65537,65538,65539,65540,65541,65542,65543,65544,65545,65546,65547,65548,65549,65550,65551};// SPI2_Buffer_Rx[BufferSize];
