...
extern uint32_t DST_Buffer[];
extern void Buffercmp(const uint32_t* pBuffer, uint32_t* pBuffer1, uint16_t BufferLength);
extern const uint32_t SRC_Const_Buffer[];
...
void DMA1_Channel6_IRQHandler(void)
{
  ...
  if(DMA_GetITStatus(DMA1_IT_TC6))
  {
	...
	printf("DMA1 Channel6 Interrupt\n\r");
